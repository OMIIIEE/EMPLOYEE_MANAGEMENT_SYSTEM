...
function EmployeeDetail() {
    ...
    useEffect(() => {
        if (employee) {
            axios.get(`${apiUrl}/employee/category/${employee.category}`)
                .then(result => {
                ...
                <div className="container-fluid">
                    <div className="row align-items-center">
                        ...
                        <div className="col-md-6 text-end d-flex justify-content-end">
                            ...
                            <div className="mx-1">
                                <Link to="/" onClick={handleLogout} className="logout-btn btn btn-outline-danger py-2 mt-1">
                            ...
                            <div className="card-body">
                                <div className="row align-items-center empCard">
                                    <div className="col-md-5 d-flex justify-content-center">
                                        <img src={`${apiUrl}/Images/${employee.image}`} className="card-img" alt="Employee" />
                                    </div>
                                    <div className="col-md-7 ml-2">
                                        <h3 className="card-title">{employee.name}</h3>
                                        <div className="details">
                                            <p><span className='detailsTitle'>Employee ID:</span> {employee._id}</p>
